...
def file_bleu(hypothesis, reference, lowercase=False):
    ...
    beaver_path = os.path.dirname(os.path.dirname(__file__))
     # os.path.dirname(os.path.dirname(os.path.dirname(__file__))) # /home/jsy
    # print(os.path.dirname(os.path.dirname(__file__))) #/home/jsy/GraphSum
