...
def data_opts(parser):
    parser.add_argument("-train", type=str, nargs=2, help="Training graph")
    parser.add_argument("-valid", type=str, nargs=2, help="Validation graph")
...
def translate_opts(parser):
    parser.add_argument("-input", type=str, help="Translation graph")
